...
?>
 ...
 <form id="frm" name="frm" method="post" action="">
            ...
            <form id="frmadd" name="frmadd" method="post" action="" enctype="multipart/form-data">
             ...
             <tr>
                	<td>Complaint</td>
					<td><textarea name="txtComplaint" maxlength="5000"></textarea></td>
                </tr>
                <tr>
...
if(isset($_REQUEST['btnsave']))
{
  ...
  $insert="INSERT INTO `tblcomplaints`(`Advocate`, `Users`, `Complaint`, `AdminReply`, `Status`) 
  VALUES ('$Mobile', $UserID,'".$_REQUEST['txtComplaint']."','','New')";
...
function check(f)
{
    if(f.txtComplaint.value=="")
    {
        alert("Feedback cannot be empty");
        f.txtComplaint.focus();
		    return false ;
    }
